...
public class InicioSesionActivity extends AppCompatActivity {
            ...
            public void onResponse(Call<LoginResponse> call, Response<LoginResponse> response) {
                ...
                if (response.isSuccessful() && response.body() != null) {
                    ...
                    if (loginResponse.getToken() != null) {
                        ...
                        sessionManager.saveUserSession(email, password, loginResponse.getUser().getNombre(), loginResponse.getUser().getFoto(), loginResponse.getToken());
                    ...
                    HttpUrl url = HttpUrl.parse("https://cocinarte-production.up.railway.app/auth/login");
                    if (url != null) {
    ...
    private void irAMainActivity() {
        Intent intent = new Intent(InicioSesionActivity.this, NavigationActivity.class);
