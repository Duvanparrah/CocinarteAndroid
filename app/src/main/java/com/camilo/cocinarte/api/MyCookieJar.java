...
public class MyCookieJar implements CookieJar {
    ...
    public void clearCookies() {
        // Borra las cookies en memoria (por ejemplo, si usas un Map<String, List<Cookie>>)
        if (cookieStore != null) {
            cookieStore.clear();
        }

        // Borra las cookies persistidas en SharedPreferences
        SharedPreferences.Editor editor = sharedPreferences.edit();
        editor.remove(COOKIE_KEY); // o editor.clear() si solo usas SharedPreferences para cookies
        editor.apply();

        Log.d("MyCookieJar", "Todas las cookies han sido eliminadas");
    }
